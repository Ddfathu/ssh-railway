...
# Diarahkan ke WS Tunnel agar payload WebSocket setelah TLS berhasil didekripsi bisa diproses
...
frontend main_gateway
    ...
    # Jika koneksi diawali TLS Handshake (pakai SNI), arahkan ke Stunnel
    # Jika request HTTP biasa / Websocket murni, arahkan ke wstunnel
